...
struct Overlay_Appearance {
    ...
    float font_size = 20.0f; // PULS3: hardcoded from configs.overlay.ini
...
public:
    ...
    int overlay_hook_delay_sec = 5; // PULS3: hardcoded from configs.overlay.ini
    int overlay_renderer_detector_timeout_sec = 35; // PULS3: hardcoded from configs.overlay.ini
    ...
    bool disable_overlay_warning_local_save = true; // PULS3: hardcoded from configs.overlay.ini
